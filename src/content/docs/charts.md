...
The custom component would receive `title` and `data` props, check out [ChartTooltip.vue component](https://github.com/radix-vue/shadcn-vue/tree/dev/apps/web/src/lib/registry/default/ui/chart/ChartTooltip.vue) for example.
